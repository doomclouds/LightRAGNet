...
- [2026-06-02-dev-start-background-worker-archives.md](./2026-06/2026-06-02-dev-start-background-worker-archives.md): 记录开发启动脚本的后台 worker 能力及后续修正：默认等待 ready 并打印 URL，显式 `-Background` 才立即释放控制台。
...
- [2026-05-27-system-status-compact-diagnostics-workbench-archives.md](./2026-05/2026-05-27-system-status-compact-diagnostics-workbench-archives.md): 将 React `/system-status` 迁移为紧凑诊断工作台，以 summary tiles、evidence table、fix-first、feature impact 和 raw JSON 辅助面板承载系统健康信息。
...
- [2026-05-24-cache-management-workbench-archives.md](./2026-05/2026-05-24-cache-management-workbench-archives.md): 增加基于真实 hit/miss 指标和安全库存的 Cache Management 工作台，并在独立 React 前端对齐 compact light workbench 表格页视觉。
